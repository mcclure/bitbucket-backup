...
extern int stb_vorbis_decode_filename(const char *filename, int *channels, short **output);
#endif
...
EXPORT int stb_vorbis_decode_memory(uint8 *mem, int len, int *channels, short **output)
{
   int data_len, offset, total, limit, error;
   short *data;
