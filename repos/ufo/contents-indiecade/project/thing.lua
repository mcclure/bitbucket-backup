...
--function keys
	...
	-- Remap keypad
	self.pressed[engine.sdl.SDL_SCANCODE_KP_0] = self.pressed[engine.sdl.SDL_SCANCODE_0]
	self.pressed[engine.sdl.SDL_SCANCODE_KP_1] = self.pressed[engine.sdl.SDL_SCANCODE_1]
	self.pressed[engine.sdl.SDL_SCANCODE_KP_2] = self.pressed[engine.sdl.SDL_SCANCODE_2]
	self.pressed[engine.sdl.SDL_SCANCODE_KP_3] = self.pressed[engine.sdl.SDL_SCANCODE_3]
	self.pressed[engine.sdl.SDL_SCANCODE_KP_4] = self.pressed[engine.sdl.SDL_SCANCODE_4]
	self.pressed[engine.sdl.SDL_SCANCODE_KP_5] = self.pressed[engine.sdl.SDL_SCANCODE_5]
	self.pressed[engine.sdl.SDL_SCANCODE_KP_6] = self.pressed[engine.sdl.SDL_SCANCODE_6]
	self.pressed[engine.sdl.SDL_SCANCODE_KP_7] = self.pressed[engine.sdl.SDL_SCANCODE_7]
	self.pressed[engine.sdl.SDL_SCANCODE_KP_8] = self.pressed[engine.sdl.SDL_SCANCODE_8]
	self.pressed[engine.sdl.SDL_SCANCODE_KP_9] = self.pressed[engine.sdl.SDL_SCANCODE_9]
	self.pressed[engine.sdl.SDL_SCANCODE_KP_PERIOD] = self.pressed[engine.sdl.SDL_SCANCODE_X]
	self.down[engine.sdl.SDL_SCANCODE_X] = self.down[engine.sdl.SDL_SCANCODE_G]
	self.pressed[engine.sdl.SDL_SCANCODE_X] = null
	self.pressed[engine.sdl.SDL_SCANCODE_G] = self.pressed[engine.sdl.SDL_SCANCODE_MINUS]
