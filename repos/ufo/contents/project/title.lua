...
function TitleRunner:onTick()
	...
	local titles = {
		...
		"Remember DELETE to rewind",
		"",
		"Pick:       (S)ketchpad      (T)utorial",
		"",
		"--------------Art lessons--------------",
		string.format("Pick mode: (P)%s  (E)%s (G)%s",
			artmode==1 and "RACTICE" or "ractice",
			artmode==2 and "XAM" or "xam",
			artmode==3 and "ALLERY" or "allery"),
		"",
		(artmode ~= 3 or tableTrue(gallery.best)) and "Pick lesson:" or "",
		""
	}
