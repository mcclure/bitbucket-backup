...
#ifndef OSK
http_retcode http_put(char *filename, const char *data, int length, 
	     int overwrite, const char *type) ;
http_retcode http_get(char *filename, char **pdata,int *plength, char *typebuf);

http_retcode http_putget(char *filename, const char *data, int length, 
                      int overwrite, const char *type, char **pdata,int *plength, char *typebuf);
