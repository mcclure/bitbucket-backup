...
#define JC_FRAMEBUFFER GL_FRAMEBUFFER_OES
#define JC_FRAMEBUFFER_COMPLETE GL_FRAMEBUFFER_COMPLETE_OES
#define JC_RENDERBUFFER GL_RENDERBUFFER_OES
#define JC_DEPTH_ATTACHMENT GL_DEPTH_ATTACHMENT_OES
#define JC_COLOR_ATTACHMENT0 GL_COLOR_ATTACHMENT0_OES
...
#define JC_FRAMEBUFFER GL_FRAMEBUFFER_EXT
#define JC_FRAMEBUFFER_COMPLETE GL_FRAMEBUFFER_COMPLETE_EXT
#define JC_RENDERBUFFER GL_RENDERBUFFER_EXT
#define JC_DEPTH_ATTACHMENT GL_DEPTH_ATTACHMENT_EXT
#define JC_COLOR_ATTACHMENT0 GL_COLOR_ATTACHMENT0_EXT
