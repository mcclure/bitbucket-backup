...
PolycodeTemplateApp::PolycodeTemplateApp(PolycodeView *view) {
	...
	core = new CocoaCore(view, surface_width,surface_height,FULLSCREEN,true, 4,0,30);
#elif defined(_WINDOWS)
	core = new Win32Core(view, surface_width,surface_height,FULLSCREEN,true, 4,0,30);
#else
	core = new SDLCore(view, surface_width,surface_height,FULLSCREEN,true, 4,0,30);
#endif
	cor = core;
