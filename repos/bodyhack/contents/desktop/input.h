...
#define AXISCODE_HIGH_MASK 0x40000000
#define AXISCODE_ZERO_MASK 0x20000000
#define AXISCODE_LOW_MASK  0x10000000
#define AXISCODE_XHAT_MASK 0x08000000
#define AXISCODE_YHAT_MASK 0x04000000
#define AXISCODE_ID_MASK   0x000000FF

#define AXISCODE_EVENT_MASK 0xF0000000
#define AXISCODE_DPAD_MASK  0x0C000000
...
// SDLK_LAST is 323
#define AXISCODE_SDLK_MASK	0x000001FF
...
struct InputRules {
	...
	hash_map<uint32_t, uint32_t> key; // Lookup by SDLKey
	...
	InputRules() : vacuum(0), rise(0), edge(0), touch(0), keyboard(0) {}
	...
	static void push(bool copy = true);
	static void pop();
