...
mkdir -p lua/Include
mkdir -p lua/Source
python ../Polycode/Bindings/Scripts/create_lua_library/create_lua_library.py lua_visible Project Polycode.h project Project ./lua/API ./lua/API/Project ./lua/Include ./lua/Source ./media/project_classes.txt
pushd lua/API
