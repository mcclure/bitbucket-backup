...
// Note from mcc: This file is not actually part of PlaidAudio, but was included by Evan in the distribution by accident.
// It should not be compiled into PlaidAudio-using applications, as it adds nothing but creates a dependency on SDL.
