...
function color_random()
	return color_make(math.random(0,255), math.random(0,255), math.random(0,255))
end
...
function blit_part( to, from, x, y, xf, yf, w, h )
	w = w or from.w
	h = h or from.h
	rect.x,   rect.y,  rect.w,  rect.h = xf or 0, yf or 0, w, h
	rect2.x, rect2.y, rect2.w, rect2.h = x or 0, y or 0, w, h
	sdl.SDL_UpperBlit( from, rect, to, rect2 )
end
