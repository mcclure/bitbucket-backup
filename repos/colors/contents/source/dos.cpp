...
void gfxcontainer::pxmix_ryb(const gfxcontainer *rg, const gfxcontainer *gg, const gfxcontainer *bg) {
	//							       r     y     ry    b     rb    yb    ryb
	const unsigned char rt[8] = {0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF};
	const unsigned char gt[8] = {0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0xFF, 0xFF};
	const unsigned char bt[8] = {0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF};
	const unsigned char at[4] = {0x00, 0xFF, 0xFF, 0xFF};
	...
	for(int y = 0; y < h; y++) {
		for(int x = 0; x < w; x++) {
			...
			unsigned int r = (rsrc[0]?1:0);
			unsigned int g = (gsrc[1]?2:0);
			unsigned int b = (bsrc[2]?4:0);
