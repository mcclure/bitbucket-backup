...
function paint_playsample_set() end -- I DON'T CARE
	...
	pull(self, {
		down = {
			...
			[engine.sdl.SDL_SCANCODE_SPACE]=function(self)
				...
				paint_playsample_set(sampleplayer, ogg_named("sfx_0"), 1, 0)
				project.circle_thing(self.stage.base, self.x, self.y)
			end,
		},
		pressed = {
			[engine.sdl.SDL_SCANCODE_X]=function(self)
				...
				paint_playsample_set(sampleplayer, ogg_named("sfx_5"), 1, 0)
			end,
			[engine.sdl.SDL_SCANCODE_V]=function(self)
				project.textify(self.stage.base)
				paint_playsample_set(sampleplayer, ogg_named("sfx_8"), 1, 0)
			end,
			[engine.sdl.SDL_SCANCODE_S]=function(self)
				...
				self.y = self.x
				self.x = temp
				paint_playsample_set(sampleplayer, ogg_named("sfx_4"), 1, 0)
			end,
			[engine.sdl.SDL_SCANCODE_H]=function(self)
				...
				MapKill(dupe)
				paint_playsample_set(sampleplayer, ogg_named("sfx_3"), 1, 0)
			end,
			[engine.sdl.SDL_SCANCODE_J]=function(self)
				...
				paint_playsample_set(sampleplayer, ogg_named("sfx_0_anti"), 1, 0)
			end,
			[engine.sdl.SDL_SCANCODE_V]=function(self)
				project.textify(self.stage.base)
				paint_playsample_set(sampleplayer, ogg_named("sfx_8"), 1, 0)
			...
			[engine.sdl.SDL_SCANCODE_MINUS]=function(self)
				...
				paint_playsample_set(sampleplayer, ogg_named("magic1"), 1, 0)
			...
			[engine.sdl.SDL_SCANCODE_UP]=function(self)
				...
				InPlacePyramid(base, dupe, inmap)
				MapKill(dupe)
				paint_playsample_set(sampleplayer, ogg_named("sfx_2"), 1, 0)
			end,
...
function Snapshot:reset()
	...
	paint_playsample_set(sampleplayer, ogg_named("sfx_6"), 1, 0)
end

function Snapshot:snap()
	engine.blit_whole(self.reserve,self.onto)
	self.last = engine.sdl.SDL_GetTicks()
	paint_playsample_set(sampleplayer, ogg_named("sfx_7"), 1, 0)
end
