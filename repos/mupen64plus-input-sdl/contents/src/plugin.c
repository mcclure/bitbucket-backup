...
/* MCC ADDITIONS */
unsigned char buttons_override_on;
BUTTONS buttons_override[4];

EXPORT void CALL ButtonsOverride( int Control, BUTTONS Keys )
{
    buttons_override[Control] = Keys;
    buttons_override_on = 1;
}

EXPORT void CALL ButtonsOverrideOff()
{
    buttons_override_on = 0;
}

EXPORT void CALL ButtonsOverrideExploded( int Control, BUTTONS_EXPLODED Keys )
{
    BUTTONS Keys2;
    Keys2.R_DPAD = Keys.R_DPAD;
    Keys2.L_DPAD = Keys.L_DPAD;
    Keys2.D_DPAD = Keys.D_DPAD;
    Keys2.U_DPAD = Keys.U_DPAD;
    Keys2.START_BUTTON = Keys.START_BUTTON;
    Keys2.Z_TRIG = Keys.Z_TRIG;
    Keys2.B_BUTTON = Keys.B_BUTTON;
    Keys2.A_BUTTON = Keys.A_BUTTON;
    Keys2.R_CBUTTON = Keys.R_CBUTTON;
    Keys2.L_CBUTTON = Keys.L_CBUTTON;
    Keys2.D_CBUTTON = Keys.D_CBUTTON;
    Keys2.U_CBUTTON = Keys.U_CBUTTON;
    Keys2.R_TRIG = Keys.R_TRIG;
    Keys2.L_TRIG = Keys.L_TRIG;
    Keys2.Reserved1 = Keys.Reserved1;
    Keys2.Reserved2 = Keys.Reserved2;
    Keys2.X_AXIS = Keys.X_AXIS;
    Keys2.Y_AXIS = Keys.Y_AXIS;
    ButtonsOverride(Control, Keys2);
}
...
EXPORT void CALL GetKeys( int Control, BUTTONS *Keys )
{
    ...
    if (buttons_override_on) {
        *Keys = buttons_override[Control];
        return;
    }
