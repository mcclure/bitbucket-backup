...
// This is the same field order as BUTTONS in the core header files, but it avoids using bitfields.
// Bitfields are bad for cross-language interoperability.
typedef struct {
    unsigned char R_DPAD;
    unsigned char L_DPAD;
    unsigned char D_DPAD;
    unsigned char U_DPAD;
    unsigned char START_BUTTON;
    unsigned char Z_TRIG;
    unsigned char B_BUTTON;
    unsigned char A_BUTTON;

    unsigned char R_CBUTTON;
    unsigned char L_CBUTTON;
    unsigned char D_CBUTTON;
    unsigned char U_CBUTTON;
