...
echo lodepng.o
%BUILD% -c %SRC_FOLDER%/../desktop/lodepng.cpp
...
%BUILD% -o %OUTFILE% main.o program.o display.o util_display.o text_display.o glCommonMatrix.o glCommon.o controls.o lodepng.o slice.o color.o tinyxml.a chipmunk.a ftgl.a tess.a "-L." "-L%PALMPDK%\device\lib" -Wl,--allow-shlib-undefined %LIBS%
