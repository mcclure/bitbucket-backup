...
JUMPCORE_SRC = $(SD)/util_display.cpp $(SD)/glCommon.cpp $(SD)/text_display.cpp $(SD)/glCommonMatrix.cpp $(SD)/controls.cpp $(SD)/color.cpp $(SD)/desktop/lodepng.cpp $(SD)/slice.cpp $(SD)/desktop/static_lib/tinyxml.cpp $(SD)/desktop/static_lib/tinyxmlerror.cpp $(SD)/desktop/static_lib/tinyxmlparser.cpp
