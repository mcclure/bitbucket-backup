...
help += "\t-q qlean (when building, qlean build directory first)\n"
...
def cmd_build():
	...
	if flag("q"):
		...
		do_rmtree([polycode_working_dir, "Release", target_platform])
