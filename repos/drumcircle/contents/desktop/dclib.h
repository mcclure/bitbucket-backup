...
struct sample_inst {
	...
	sample_inst(const char *_name = NULL, double *_samp = NULL, int _len = 0, int _pmod = 0, subtexture_slice *_icon = 0) : name(_name), samp(_samp), len(_len), pmod(_pmod), icon(_icon) {}
