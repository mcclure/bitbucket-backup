...
-- A point, intended for integer points. TODO: Should integrate with Vector2 somehow?
class "P"
...
function P:travelidx(idx)
	return self:travel(idx%2 == 1 and "x" or "y", idx > 2 and 1 or -1)
end
...
-- A rectangle, intended for integer points. TODO: Should integrate with cpRect somehow?
class "Rect"
