...
struct gfxcontainer {
	...
	void pxpaint(int x, int y, int c);
...
struct type_automaton : public automaton, public gfxcontainer {
	...
	void set_centered(int x, int y, int w, string s, bool clearfirst = true, bool inv = false);
	void fill(int x=0, int y=0, int dx=DOS_LINE_COLS, int dy=DOS_LINE_ROWS, String s = String());
	void fill(int x=0, int y=0, int dx=DOS_LINE_COLS, int dy=DOS_LINE_ROWS, unsigned char s = DOS_BLANK);
