...
${PYTHON:-python} Polycode/Framework/Extra/create_lua_library.py lua_visible.txt Project Polycode.h project Project ./lua/API ./lua/API/Project ./lua/Include ./lua/Source - ./media/project_classes.txt
pushd lua/API
...
pushd Polycode/Framework/Bindings/Lua/Modules/UI/API
rm -f UI.pak
zip -r UI.pak *
popd
mv Polycode/Framework/Bindings/Lua/Modules/UI/API/UI.pak .  
