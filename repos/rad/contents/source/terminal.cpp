...
void terminal_auto::init_interpreter() {
	...
	lua_require("Physics3D/CollisionScene");
	lua_require("Physics3D/CollisionSceneEntity");
	lua_require("Physics3D/PhysicsCharacter");
	lua_require("Physics3D/PhysicsScene");
	lua_require("Physics3D/PhysicsSceneEntity");
	lua_require("Physics3D/PhysicsSceneEvent");
	lua_require("Project/StringArray");
	lua_require("Project/VectorArray");
	lua_require("Project/EntityArray");
