...
terminal_auto::terminal_auto() : automaton(), entry(NULL), output(NULL), line_height(0), line_descender(0),
	max_width(0), max_height(0), output_line(0), want_reset(false), L(NULL)
#if TERMINAL_LOG
