...
class Settings(QDialog, Ui_Settings):
    ...
    def connect_signals(self):
        ...
        self.browseScripts.clicked.connect(lambda: self.browse_dialog(
            (self.pathScripts, self.groupScripts, True)))
    ...
    def save_paths(self):
        ...
        self.qset.setValue("Paths/Scripts", self.pathScripts.text())
