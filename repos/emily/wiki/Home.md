...
*Update 2016-5-19: The content on this page is from April 2015 and concerns version 0.2, the most recent stable release of Emily. Some developments since then you might want to be aware of: I [gave a talk](https://www.youtube.com/watch?v=gMZsc3cvwKs) at Lambdaconf 2015 talking about the design of Emily; there is an unstable 0.3 branch which is not yet fully documented, but has C interoperability and has been successfully used to make a small [SDL-based game](https://bitbucket.org/runhello/test-emily-game); and an exploratory project to make an [Emily compiler](https://bitbucket.org/runhello/emily-lua) is underway. Hopefully more updates soon!*
...
If you happen to use "homebrew" for Mac OS X, Misty De Meo has helpfully put together a [homebrew package](https://github.com/mistydemeo/homebrew-emily). You can install Emily via brew by running:

    brew install mistydemeo/emily/emily

If you use Debian or Ubuntu, there is an apt repository with 64-bit packages. You can install Emily by running:

    sudo echo 'deb http://dl.bintray.com/emily/debian wheezy main' >> /etc/apt/sources.list
    wget -qO - 'https://bintray.com/user/downloadSubjectPublicKey?username=bintray' | sudo apt-key add -
    sudo apt-get update
    sudo apt-get install emily

If you're an Arch Linux user, Ludovic Coues has made emily available [on the AUR](https://aur.archlinux.org/packages/emily/). If you're using Arch you're probably already familiar with the AUR, but if not [the wiki](https://wiki.archlinux.org/index.php/Arch_User_Repository#Installing_packages) has some information on how to use it. For people using the yaourt AUR helper, simply run:

    sudo yaourt -S emily

### Getting started

If you're interested in Emily and want to give it a shot, a good thing to read next would be the [tutorial](https://bitbucket.org/runhello/emily/src/stable/doc/tutorial.md). If you just want to know more, there's a bunch of documentation including some design documents and information about modding the language in the [docs folder](https://bitbucket.org/runhello/emily/src/stable/doc/).

### License

Emily is MIT licensed, meaning it is open source and only attribution for the authors is required. The list of contributors is [here](https://bitbucket.org/runhello/emily/src/stable/LICENSE.md).
