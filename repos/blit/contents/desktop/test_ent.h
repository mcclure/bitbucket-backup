...
void slice_scale(slice *dst, slice *src, int scale);
void slice_blit(slice *dst, slice *src, int dst_x = 0, int dst_y = 0, int dx = -1, int dy = -1);
void slice_blut(slice *dst, slice *src, int dst_x = 0, int dst_y = 0, int dx = -1, int dy = -1);
