...
void slice_scale(slice *dst, slice *src, int pixelscale) {
...
// dst is larger
void slice_blit(slice *dst, slice *src, int dst_x, int dst_y, int dx, int dy) {
...
// src is larger
void slice_blut(slice *dst, slice *src, int dst_x, int dst_y, int dx, int dy) {
